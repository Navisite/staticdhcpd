...
class DHCPServer(object):
    ...
    def __init__(self, server_address, server_port, client_port, pxe_port=None, response_interface=None, response_interface_qtags=None, listen_interface=None):
        """
        ...
        self._network_link = _NetworkLink(str(server_address), server_port, client_port, pxe_port, response_interface, response_interface_qtags=response_interface_qtags, listen_interface=listen_interface)
...
class _NetworkLink(object):
    ...
    def __init__(self, server_address, server_port, client_port, pxe_port, response_interface=None, response_interface_qtags=None, listen_interface=None):
        """
        Sets up the DHCP network infrastructure.
        ...
        (dhcp_socket, pxe_socket) = self._setupListeningSockets(server_port, pxe_port, listen_interface)
        if pxe_socket:
    ...
    def _setupListeningSockets(self, server_port, pxe_port, listen_interface=None):
        """
